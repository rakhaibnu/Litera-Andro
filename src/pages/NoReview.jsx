...
export default function NoReview() {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 font-merriweather gap-2">
        ...
        <Link to="/review" className="mt-6 bg-warm-sand-5 hover:bg-warm-sand-9 text-white text-lg px-4 py-2 rounded-full transition duration-300">
            Go review a book
        </Link>
        </div>
    );
