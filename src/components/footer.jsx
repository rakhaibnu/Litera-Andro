...
const Footer = () => {
  return (
    <footer className="font-inter bg-dark text-primary py-8 px-4">
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center">
          {/* Bagian Kiri */}
          <div className="mb-4 md:mb-0">
            <h3 className="text-xl font-bold mb-2">Projek Capstone</h3>
            <p className="text-sm">© 2023 Tim Andro. All rights reserved.</p>
          </div>
        ...
        {/* Pembatas */}
        <div className="border-t border-primary mt-6 pt-6 text-center text-sm">
